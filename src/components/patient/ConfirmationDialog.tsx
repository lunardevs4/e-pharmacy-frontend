...
export default function ConfirmationDialog({
  ...
  return (
    <div className="fixed inset-0 z-55 flex items-center justify-center px-4 py-6" role="dialog" aria-modal="true" aria-labelledby="dialog-title" aria-describedby="dialog-message">
      <div onClick={onCancel} aria-hidden="true" className="portal-modal-backdrop absolute inset-0 bg-gray-900/50 backdrop-blur-xs transition-opacity" />
      ...
      <div ref={dialogRef} className="portal-modal-panel relative w-full max-w-sm bg-white rounded-xl border border-gray-250 shadow-2xl p-5 z-55 flex flex-col space-y-4 animate-scaleUp">
        <div className="flex items-start space-x-3.5">
          ...
          <div className="space-y-1 flex-grow">
            ...
            <p id="dialog-message" className="text-xs text-gray-500 leading-normal">{message}</p>
          </div>
        </div>
