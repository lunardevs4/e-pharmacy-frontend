...
export default function PharmacyReports() {
  ...
  return <div className="space-y-6 max-w-7xl mx-auto pb-16">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div className="bg-white border border-gray-200 rounded-xl p-5"><h3 className="font-black mb-3">Reservation Activity</h3><Line data={lineData} options={chartOptions} /></div>
